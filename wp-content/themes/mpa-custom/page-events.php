        ...
        <div class="top-events-layout">
            ...
            <div class="featured-events-section">
                ...
                <div class="featured-events-grid" id="upcomingEventsGrid">
                    <?php
                    // Query for next 2 upcoming events (PHP, not JavaScript)
                    ...
                    if ($upcoming_query->have_posts()) :
                        while ($upcoming_query->have_posts()) : $upcoming_query->the_post();
                            ...
                            <div class="event-card featured" data-event-status="upcoming" data-event-type="<?php echo esc_attr($event_type); ?>" data-event-date="<?php echo esc_attr($event_date); ?>">
...
<section class="events-page" id="all-events">
    <div class="container">
        ...
        <?php
        // Get filter from URL, default to 'upcoming'
        $current_filter = isset($_GET['filter']) ? sanitize_text_field($_GET['filter']) : 'upcoming';
        ?>
        <div class="filter-tabs">
            <a href="?filter=upcoming" class="filter-tab <?php echo $current_filter === 'upcoming' ? 'active' : ''; ?>">Upcoming</a>
            <a href="?filter=webinar" class="filter-tab <?php echo $current_filter === 'webinar' ? 'active' : ''; ?>">Webinars</a>
            <a href="?filter=summit" class="filter-tab <?php echo $current_filter === 'summit' ? 'active' : ''; ?>">Summit</a>
            <a href="?filter=past" class="filter-tab <?php echo $current_filter === 'past' ? 'active' : ''; ?>">Past Events</a>
            <a href="?filter=all" class="filter-tab <?php echo $current_filter === 'all' ? 'active' : ''; ?>">All Events</a>
        </div>
        <div class="events-grid"><?php
            ...
            // Filter by type or date based on selected filter
            if ($current_filter === 'webinar') {
                ...
                $query_args['order'] = 'ASC';
            } elseif ($current_filter === 'upcoming') {
                $query_args['meta_query'] = array(
                    array(
                        'key' => '_event_date',
                        'value' => $today_string,
                ...
                $query_args['order'] = 'DESC'; // Most recent first for past events
            } else {
...
<script>
    // PHP renders everything now - only minimal JS for calendar/subscription functionality
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // No JavaScript filtering needed - PHP handles it all
    });
</script>

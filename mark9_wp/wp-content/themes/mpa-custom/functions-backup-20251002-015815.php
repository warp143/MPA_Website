...
function mpa_member_details_callback($post) {
    ...
    <p>
        <label for="member_categories"><strong>Categories:</strong></label><br>
        <small>Enter categories separated by commas (e.g., Crowdfunding, Fintech, IoT)</small><br>
        <input type="text" id="member_categories" name="member_categories" value="<?php echo esc_attr($categories); ?>" style="width: 100%;" placeholder="Crowdfunding, Fintech">
    </p>

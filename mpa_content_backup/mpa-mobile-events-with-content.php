<?php
/*
Plugin Name: MPA Mobile Events with Content
Description: Mobile-responsive events page that actually shows events from categories 303 and 344
Version: 1.0
...
class MPA_Mobile_Events_Content {
    ...
    private function get_mobile_css() {
        return '
        /* MPA MOBILE EVENTS - COMPLETE MOBILE DESIGN */

<?php
/*
Plugin Name: MPA Mobile Events Compact
Description: Mobile-responsive events page with smaller header (1/4 page height)
Version: 1.2
...
class MPA_Mobile_Events_Compact {
    ...
    private function get_mobile_events_content() {
        ...
        <div class="mpa-mobile-events-wrapper">
            ...
            <div class="mpa-mobile-header-compact">
                <div class="mpa-header-gradient"></div>
                <div class="mpa-header-content">
                    <h1>Events</h1>
                    <p>because we like to gather and huddle</p>
                </div>
            </div>
    ...
    private function get_mobile_css() {
        return '
        /* MPA MOBILE EVENTS - COMPACT HEADER (1/4 PAGE) */
        @media screen and (max-width: 768px) {
            ...
            /* COMPACT Mobile Header - 1/4 page height */
            .mpa-mobile-header-compact {
                position: relative !important;
                height: 25vh !important; /* 1/4 of viewport height instead of 50% */
                min-height: 150px !important; /* Minimum height for readability */
                max-height: 200px !important; /* Maximum height to keep it compact */
            ...
            .mpa-header-gradient {
                ...
                right: 0 !important;
                bottom: 0 !important;
                background-image: url("http://4.194.249.21/wp-content/uploads/2021/08/MPA-Header-Events-01.png") !important;
            ...
            .mpa-header-content h1 {
                font-size: 1.5rem !important; /* Slightly smaller font for compact header */
            ...
            .mpa-event-image {
                position: relative !important;
                height: 80px !important; /* Smaller event card images too */
            ...
            .mpa-event-card.featured .mpa-event-image {
                height: 100px !important; /* Featured event slightly larger but still compact */
            }
            ...
            .mpa-event-icon {
                font-size: 1.8rem !important; /* Smaller icons */
                color: white !important;
            ...
            .mpa-event-card.featured .mpa-event-title {
                font-size: 1.25rem !important; /* Slightly larger but not huge */
                font-weight: 700 !important;
            }
            ...
            @media screen and (max-height: 600px) {
                .mpa-mobile-header-compact {
                    height: 120px !important; /* Fixed height for very small screens */

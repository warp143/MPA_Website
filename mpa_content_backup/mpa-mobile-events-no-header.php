<?php
/*
Plugin Name: MPA Mobile Events No Header
Description: Mobile-responsive events page without duplicate background header
Version: 1.3
...
class MPA_Mobile_Events_No_Header {
    ...
    private function get_mobile_events_content() {
        ...
        <div class="mpa-mobile-events-wrapper">
            ...
            <!-- Filter Tabs - NO HEADER, START WITH TABS -->
    ...
    private function get_mobile_css() {
        return '
        /* MPA MOBILE EVENTS - NO DUPLICATE HEADER */
        @media screen and (max-width: 768px) {
            
            /* Mobile Events Wrapper - NO HEADER BACKGROUND */
...
new MPA_Mobile_Events_No_Header();
